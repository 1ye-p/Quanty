...
export function OverfitScore({ score }: { score: number }) {
  ...
  const label = score > 0.7
    ? t('component.overfitting.hint.overfit_significant')
    : score > 0.4
      ? t('component.overfitting.hint.overfit_mild')
      : t('component.overfitting.hint.overfit_low')
